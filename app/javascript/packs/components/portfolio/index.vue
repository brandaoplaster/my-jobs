				...
				<form>
						...
						<div class="input-field col l4 m6 s12">
							...
							<label class="active font_20 custom-grey-text text-darken-1">
								Slug
									...
									data-tooltip="Nome que vai aparecer na URL"></i>
							</label>
						</div>
						<div class="col l2 m2 s12 slug-actions hide-on-small-and-down">
							<i class="far fa-copy element tooltipped" data-tooltip="Copiar para o Clipboard"
								@click="copyToClipboard()"></i>
							<a :href="`/portfolios/${ portfolio.id }`" data-tooltip="Visualizar"
								class="fa fa-external-link-square-alt element tooltipped"></a>
						</div>
						...
						<div class="col offset-l2 l2 m2 s6 center">
							<label class="font_16 custom-grey-text text-darken-1">
								...
								<i class="fa fa-info-circle tooltipped" data-position="bottom"
									data-tooltip="Pode ser encontrado pela URL"></i>
							</label>

							<div class="switch">
								<label>
									<input name="portfolio[active]" v-model="portfolio.active" type="checkbox"
										@change="update()"/>
							...
							<div class="col l2 m2 s6 center">
								<label class="font_16 custom-grey-text text-darken-1">
									Listado
									<i class="fa fa-info-circle tooltipped"
											data-tooltip="Aparece nas pesquisas por candidatos"></i>
								</label>
								<div class="switch">
									<label>
										<input name="portfolio[listed]" v-model="portfolio.listed" type="checkbox"
											@change="update()"/>
										<span class="lever"></span>
									</label>
								</div>
					...
					<div class="row">
						...
						<div class="input-field col l2 offset-m1 m4 offset-s4 s4">
							<label>
									<input name="portfolio[remote_ok]" v-model="portfolio.remote_ok" type="checkbox"
										class="filled-in" @change="update()"/>
									<span>Remote OK</span>
							</label>
						</div>
					</div>
